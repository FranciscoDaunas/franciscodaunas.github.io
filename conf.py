...
BLOG_AUTHOR = "J. Francisco Daunas"  # (translatable)
BLOG_TITLE = "J. Francisco Daunas"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://franciscodaunase.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://franciscodaunase.com/"
BLOG_EMAIL = "jdaunastorres1@sheffield.ac.uk"
BLOG_DESCRIPTION = "This is a personal accademic webpage."  # (translatable)
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}'
